...
import {
  Loader2, AlertCircle, Moon, Sun, Eye, EyeOff,
  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="relative hidden lg:flex lg:w-[46%] flex-col justify-between overflow-hidden bg-zinc-950 p-12 text-white">
        ...
        />
        <div className="absolute -top-24 -left-16 h-72 w-72 rounded-full bg-blue-600/40 blur-3xl animate-blob" />
        <div className="absolute top-1/3 -right-10 h-64 w-64 rounded-full bg-sky-500/30 blur-3xl animate-blob animation-delay-2000" />
        <div className="absolute -bottom-20 left-1/4 h-72 w-72 rounded-full bg-blue-700/30 blur-3xl animate-blob animation-delay-4000" />

        <div className="relative z-10 flex items-center gap-3 animate-fade-in-up">
          <img src="/download.jpg" alt="Finifi Logo" className="h-10 w-10 rounded-xl object-cover shadow-lg" />
      ...
      <div className="relative flex flex-1 items-center justify-center overflow-hidden px-4 py-12">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 60% 50% at 50% 0%, rgba(37,99,235,0.12), transparent), radial-gradient(ellipse 50% 40% at 90% 90%, rgba(37,99,235,0.10), transparent)',
          }}
        />
        <div
        ...
        <div className="absolute right-[12%] top-[18%] hidden xl:block animate-float-slow">
          <div className="h-14 w-14 rounded-2xl border border-blue-500/20 bg-blue-500/5 backdrop-blur-sm" />
        </div>
        <div className="absolute right-[20%] bottom-[20%] hidden xl:block animate-float-slow animation-delay-1000">
          <div className="h-9 w-9 rounded-full border border-sky-400/20 bg-sky-400/5 backdrop-blur-sm" />
        </div>
        ...
        <div className="relative z-10 w-full max-w-[400px] animate-fade-in-up">
          ...
          <div className="mb-8 flex flex-col items-center lg:hidden">
            <img src="/download.jpg" alt="Finifi Logo" className="mb-4 h-12 w-12 rounded-xl object-cover shadow-lg shadow-blue-600/20" />
            <h1 className="text-xl font-bold">Finifi Match</h1>
            <p className="mt-1 text-sm text-muted-foreground">Three-Way Match Engine</p>
          </div>

          <div className="relative rounded-[28px] bg-gradient-to-b from-blue-500/40 via-blue-500/10 to-transparent p-[1px]">
            <div className="rounded-[27px] bg-card border border-border/60 shadow-2xl shadow-black/[0.06] dark:shadow-black/40 p-8 sm:p-9">
              {/* eyebrow badge */}
              <div className="hidden lg:inline-flex items-center gap-1.5 rounded-full bg-blue-50 dark:bg-blue-500/10 px-3 py-1 text-[11px] font-medium text-blue-700 dark:text-blue-400 mb-5">
                <span className="relative flex h-1.5 w-1.5">
                  <span className="absolute inline-flex h-full w-full rounded-full bg-blue-500 animate-pulse-dot" />
                </span>
                Secure sign in
              </div>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="group">
                  <label className="block text-xs font-medium text-muted-foreground mb-1.5 transition-colors group-focus-within:text-blue-600">
                    Email
                  </label>
                  <div className="relative">
                    <Mail
                      size={16}
                      className="absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-400 transition-colors group-focus-within:text-blue-500"
                    />
                    <input
                      type="email"
                      value={email}
                      onChange={(e) => setEmail(e.target.value)}
                      className="w-full border border-border rounded-xl pl-10 pr-3 py-3 text-sm outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-background"
                ...
                <div className="group">
                  <div className="flex items-center justify-between mb-1.5">
                    <label className="block text-xs font-medium text-muted-foreground transition-colors group-focus-within:text-blue-600">
                      Password
                    </label>
                    <button
                      type="button"
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full border border-border rounded-xl pl-10 pr-10 py-3 text-sm outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-background"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="group w-full bg-blue-600 text-white py-3 rounded-xl text-sm font-medium hover:bg-blue-700 active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100 transition-all duration-150 inline-flex items-center justify-center gap-2 shadow-lg shadow-blue-600/25"
                >
                  {loading ? (
                    <>
